...
1. Определите класс Book, который имеет три атрибута: __title__ (название), __author__ (автор), и __year__ (год издания).
...
1. Определите класс __Circle__ для представления круга.
2. Используйте конструктор __init__ для инициализации радиуса круга (__radius__).
