...
1. Создайте класс **UserAccount**, который представляет аккаунт пользователя с атрибутами: имя пользователя (__username__), электронная почта (__email__) и приватный атрибут пароль (__password__).
...
4. Реализуйте метод **check_password(password)**, который проверяет, соответствует ли введённый пароль текущему паролю аккаунта и возвращает __True__ или __False__.
